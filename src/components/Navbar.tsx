...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const clinicMenuCatalog: MenuCategory[] = [
    ...
    {
      id: 'agenda',
      title: 'Agenda Clínica & Lembretes WhatsApp',
      description: 'Gestão de horários presenciais e online, filtros de status e redução de faltas.',
      icon: Calendar,
      color: 'from-[#38ef7d] to-[#11998e]',
      items: [
        {
          id: 'age-calendario',
          title: 'Calendário Diário, Semanal e Mensal',
          subtitle: 'Visualização intuitiva com separação de consultas presenciais e telemedicina',
          category: 'agenda',
        ...
        },
        {
          ...
          subtitle: 'Marque sessões vinculando paciente, modalidade, horário e honorários',
          category: 'agenda',
